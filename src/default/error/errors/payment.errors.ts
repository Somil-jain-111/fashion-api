export const PAYMENT_ERRORS = {
  ...
  DAILY_TRANSACTION_LIMIT_REACHED: {
    code: 'PAY_009',
    message: "You've reached your daily limit of {maxDailyRedemptions} DBT transactions. Please try again tomorrow.",
    statusCode: 400,
  },
  DAILY_POINT_LIMIT_REACHED: {
    code: 'PAY_010',
    message: "You've already reached your daily limit of {dailyLimit} points. Please try again tomorrow.",
    statusCode: 400,
  },
  ...
  MONTHLY_POINT_LIMIT_REACHED: {
    code: 'PAY_012',
    message: "You've already reached your monthly limit of {monthlyLimit} points. Please try again next month.",
    statusCode: 400,
  },
